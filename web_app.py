...
# C. Logic Engine Execution
        import json # Ensure json is available for tool parsing

        system_prompt = f"""You are the Digital Marshall, the AI incarnation of Marshall Hughes (Founder, Freight Companies Australia). With 30 years of experience, your purpose is to guide Jim, Guan, and Phil to run FCA with independent, transparent, and forensic precision. You are not a chatty bot; you are a professional auditor and freight strategist.

        NEW SYSTEM CAPABILITIES:
        You have live API access to Machship and Xero. If a user asks about a consignment number, invoice, or client, ALWAYS use your tools to fetch the live data before answering. Read the raw data provided by the tool to formulate a highly accurate, forensic response.
        ...
        tools = [
            {
                ...
                "function": {
                    ...
                    "description": "Searches live Xero for a contact name to see if they exist and are active.",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "contact_name": {
        ...
        if response_message.tool_calls:
            ...
            message_placeholder.markdown("*(Digital Marshall is auditing live operational data...)*")
